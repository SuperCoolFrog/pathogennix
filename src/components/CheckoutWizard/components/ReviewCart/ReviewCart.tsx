...
import WizardStepBaseProps from '../WizardStepBase/WizardStepBaseProps';
...
interface ReviewCartProps extends WizardStepBaseProps {}
      ...
      <div className={"pure-u-1-3"}>
        <div className={styles.actionsContainer}>
          ...
          <div className={styles.billingButtonContainer}>
            <button className={styles.billingButton}>Proceed to Payment</button>
          </div>
        </div>
      </div>
    </div>
